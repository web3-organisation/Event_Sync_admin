import { Create, SimpleForm, TextInput, required, SaveButton, Toolbar, useNotify, useRedirect } from "react-admin";
    ...
    <Box sx={{ maxWidth: 560, mx: "auto" }}>
      ...
      <Box sx={{ mb: 3 }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 0.5 }}>
          <Box sx={{ width: 36, height: 36, borderRadius: "10px", background: "linear-gradient(135deg, rgba(108,99,255,0.25), rgba(236,72,153,0.1))", border: "1px solid rgba(108,99,255,0.25)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <Create
        ...
        redirect="list"
        mutationOptions={{
          onSuccess: () => { notify("Salle créée avec succès", { type: "success" }); redirect("list", "rooms"); },
